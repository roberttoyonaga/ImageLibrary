...
## Testing
Unit tests can be found in `/photoApp/test_photoApp.py` and can be run using `docker exec -it photoAppContainer python3 -m unittest /home/ImageLibrary/photoApp/test_photoApp.py` from the root directory of the repository.
